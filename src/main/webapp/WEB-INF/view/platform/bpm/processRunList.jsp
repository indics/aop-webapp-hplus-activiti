...
<body>
			<div class="panel">
				...
				<div class="panel-body">
					    ...
					    <display:table name="processRunList" id="processRunItem" requestURI="list.ht" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid">
							<display:column title="${checkAll}" media="html" style="width:30px;">
								  	<input type="checkbox" class="pk" name="runId" value="${processRunItem.runId}">
							</display:column>
							<display:column property="subject" title="流程实例标题" href="get.ht" paramId="runId" paramProperty="runId" maxLength="18" sortable="true" sortName="subject" style="text-align:left"></display:column>
