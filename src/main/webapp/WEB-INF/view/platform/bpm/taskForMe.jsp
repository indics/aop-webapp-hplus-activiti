...
<body>
	<div class="panel">
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="forMe.ht">
					<div class="row">
						...
						<option value="直接下单采购">直接下单采购</option>
						<option value="PMC询报价审签流程">PMC询报价审签流程</option>
						<option value="采购招投标">采购招投标</option>
		...
		<div class="panel-body">
			    ...
			    <display:table name="taskList" id="taskItem" requestURI="getAllMyTask.ht" sort="external" cellpadding="1" cellspacing="1"  class="table-grid">
