...
<script type="text/javascript" src="${ctx}/js/cosim/platform/bpm/showModalDialog.js"  charset="UTF-8"></script>
<script type="text/javascript" src="${ctx}/js/cosim/platform/bpm/ProcessUrgeDialog.js"></script>
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="myStart.ht">
					<div class="row">
							 ...
							 <span class="label">状态:</span> <select name="Q_status_SN" value="${param['Q_status_SN']}">
