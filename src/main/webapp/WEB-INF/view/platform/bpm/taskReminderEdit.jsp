...
<script type="text/javascript" src="${ctx}/js/cosim/platform/system/TemplateDialog.js"></script>
		...
		*/
		function generateExpress(obj){
			...
			case 'number':
				...
				break;
			case 'date':
				flowVarValue = "com.cosim.core.util.TimeUtil.convertString(\""+flowVarValue+'\","yyyy-MM-dd HH:mm:ss")';
				switch(flowVarOperate){
				case "eq":
