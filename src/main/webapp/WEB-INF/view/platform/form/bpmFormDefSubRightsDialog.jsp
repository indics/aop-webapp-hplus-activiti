...
<script type="text/javascript" src="${ctx}/js/cosim/platform/form/SubRightsTree.js"></script>
...
<script type="text/javascript" src="${ctx}/js/cosim/platform/form/SubRights.js"></script>
